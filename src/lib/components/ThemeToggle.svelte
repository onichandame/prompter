<button
	...
	class="text-zinc-500 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-white transition-colors cursor-pointer p-2 rounded-md hover:bg-zinc-100 dark:hover:bg-zinc-800/50"
